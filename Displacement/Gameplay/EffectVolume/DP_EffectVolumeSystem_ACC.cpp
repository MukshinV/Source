...
void UDP_EffectVolumeSystem_ACC::RegisterEffectVolume(ADP_EffectVolume_CA* _effectVolume)
{
	...
	UU5_Event_BlueprintLibrary::EventHandleToString(volumeHandleString, _effectVolume->VolumeHandle);
...
{
	FString volumeHandleString{};
	UU5_Event_BlueprintLibrary::EventHandleToString(volumeHandleString, _effectVolumeReceiver->TargetVolumeHandle);
